...
comb_df['county_name'] = comb_df['CTYNAME'] + ', ' + comb_df['USPS']


sequence = ['STNAME', 'GEOID', 'county_name', 'ALAND_SQMI', 'log_aland_sqmi', 'POPESTIMATE2015', 'log_pop_est_2015',
...
sorted_df.columns = ['state_name', 'geo_id', 'county_name', 'area_sqmi', 'log_aland_sqmi', 'pop_est_2015',
